...
@onready var health_bar := $MarginContainer/Control/VBoxContainer/Health
@onready var mana_bar := $MarginContainer/Control/VBoxContainer/Mana
@onready var skill_1 := $MarginContainer/Control/HBoxContainer/Skill1
@onready var skill_2 := $MarginContainer/Control/HBoxContainer/Skill2
@onready var skill_3 := $MarginContainer/Control/HBoxContainer/Skill3
