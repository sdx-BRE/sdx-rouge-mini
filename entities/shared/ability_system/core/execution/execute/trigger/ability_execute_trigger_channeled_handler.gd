class_name AbilityExecuteTriggerChanneledHandler extends AbilityExecuteTriggerHandler

var _data: AbilityTriggerChanneled

var _next_tick := 0.0

func setup(data: AbilityTrigger) -> void:
	_data = data
	_next_tick = 0.0
